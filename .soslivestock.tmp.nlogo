...
@#$#@#$#@
<experiments>
  <experiment name="SA_set-X-size" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    ...
    <steppedValueSet variable="set-X-size" first="10" step="5" last="30"/>
